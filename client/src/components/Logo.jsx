...
const Logo = (props) => {
    ...
    return (
        <div class="flex flex-row p-5 border-solid rounded-lg border-white border-4">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="120px" height="30px" viewBox="0 0 120 30" version="1.1" class="injected-svg js-svg-inject">
                <defs>
            ...
            <p class="font-f1Bold text-xl ml-6 text-white">
